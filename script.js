...
const arabicServiceCopy = {
  "lifestyle-concierge": {
    ...
    description: "مواعيدك وطلباتك اليومية تُدار وفق تفضيلاتك وبخصوصية عالية.",
  ...
  "travel-management": {
    ...
    description: "برنامج واحد يجمع الرحلات، الإقامة، التنقلات، الحجوزات، وأي تعديلات طارئة.",
  ...
  "private-aviation": {
    ...
    description: "خيارات الطائرة والمسار وأوقات الإقلاع والخدمات المرافقة ضمن تنسيق واحد.",
  ...
  "luxury-accommodation": {
    ...
    description: "خيارات فلل وشاليهات وبنتهاوس وإقامات خاصة مع الخدمات المطلوبة قبل الوصول وأثناء الإقامة.",
  ...
  "yacht-charters": {
    ...
    description: "اليخت، المسار، الطاقم، الضيافة، وتنقلات الضيوف تُرتب حسب مدة الرحلة وطبيعتها.",
  ...
  "health-wellness-resorts": {
    ...
    description: "خيارات منتجعات وبرامج مناسبة للتعافي أو الراحة، مع تنسيق السفر والإقامة.",
  ...
  "shopping-gifting": {
    ...
    description: "دعم في البحث والاختيار والشراء والتغليف والتوصيل حسب الشخص والمناسبة والميزانية.",
  ...
  "business-travel-management": {
    ...
    description: "رحلاتك وإقامتك وتنقلاتك وجدول اجتماعاتك ضمن خطة واحدة قابلة للتعديل.",
  ...
  "personal-assistant": {
    ...
    description: "الطلبات الحساسة أو المعقدة تتحول إلى خطوات واضحة حتى الاكتمال.",
  ...
  "special-request": {
    ...
    description: "طلبك يُراجع بواقعية مع تصور واضح لما يمكن تنفيذه.",
  ...
  "transportation-services": {
    ...
    description: "سيارات وسائقون ومسارات وجداول وصول للرحلات اليومية أو الضيوف أو المناسبات.",
  ...
  "corporate-concierge-services": {
    ...
    description: "استقبال الضيوف، السفر، التنقلات، الضيافة، وتفاصيل الزيارة بما يناسب مستوى شركتك.",
  ...
  "event-planning": {
    ...
    description: "الفكرة، الموقع، الموردون، الضيافة، وحركة الضيوف ضمن خطة واحدة.",
  ...
  "arts-design": {
    ...
    description: "وصول إلى مصممين ومعارض وأعمال فنية وموردين لتطوير مساحتك أو مجموعتك الخاصة.",
  ...
  "vip-access": {
    ...
    description: "طلب الوصول إلى فعالية أو موقع أو مطعم يُراجع حسب التوقيت والتوفر والخصوصية.",
  ...
  "real-estate": {
    ...
    description: "دعم في البحث عن مساكن أو فرص عقارية مختارة، مع ترتيب الزيارات والتقييم الأولي.",
...
const content = {
  ...
  ar: {
    ...
    cover: {
      label: "",
      title: "طلباتك الخاصة بمسار واضح.",
      desc: "سفر، إقامة، تنقل، ضيافة، وصول خاص، أو مناسبة — من الطلب حتى التأكيد.",
      sub: "كونسيرج خاص · سفر · ضيافة · وصول · مناسبات",
      visual: "طلبك الخاص يدار بمعايير تنفيذ واضحة."
    },
    summary: "للطلبات الخاصة أو الحساسة، تحصل على جهة واحدة تراجع الخيارات، ترتب التفاصيل، وتتابع التنفيذ <strong>بخصوصية ووضوح</strong>.",
    sections: {
      essence: {
        num: "02",
        title: "ما تحصل عليه",
        ...
        body: [
          "مسار واضح للطلبات التي تحتاج وقتاً، علاقات، ومتابعة دقيقة.",
          "يتم تحديد المطلوب، اختيار المسار الأنسب، ومتابعة التنفيذ حتى الاكتمال."
        ],
        cards: [
          ["التنفيذ", "طلبك يتحول إلى خطة واضحة ومسؤوليات محددة."],
          ["المتابعة", "المواعيد والتأكيدات تُتابع نيابة عنك."],
          ["الخصوصية", "معلوماتك وتفاصيل طلبك تبقى ضمن نطاق محدود."]
        ]
      },
      principles: {
        num: "03",
        ...
        cards: [
          ["الثقة", "طلبك يدار عبر جهة واضحة من البداية حتى التأكيد."],
          ["الخصوصية", "تفاصيلك، وجهتك، وضيوفك تبقى ضمن نطاق محدود."],
      ...
      global: {
        ...
        body: ["يمكن ترتيب طلبك داخل المملكة وخارجها عبر شبكة شركاء مختارة.", "تحصل على خيارات واضحة حسب الوجهة والوقت والميزانية."],
      ...
      ecosystem: {
        ...
        body: ["طلبك يستفيد من شركاء في الضيافة، السفر، التنقل، العقار، والمناسبات، مع توضيح التوفر والشروط قبل التنفيذ."],
      ...
      segments: {
        ...
        cards: [
          ["إذا كنت فرداً", "دعم في السفر، الطلبات الشخصية، الوصول الخاص، والتنسيق اليومي.", "كونسيرج نمط الحياة، المساعد الشخصي، الوصول الخاص"],
          ["إذا كنت تنفيذياً أو شركة", "تنسيق سفر الأعمال، استقبال الضيوف، الاجتماعات، والضيافة.", "سفر الأعمال، كونسيرج الشركات، التنقل"],
          ["إذا كان الطلب عائلياً", "تنسيق الإقامات، السفر، المناسبات، والخدمات المرتبطة بالمنزل.", "الإقامة الفاخرة، إدارة السفر، كونسيرج نمط الحياة"],
      ...
      standard: {
        ...
        label: "مبادئ الخدمة",
        cards: [
          ["خصوصيتك", "معلوماتك وتفاصيل طلبك تبقى ضمن نطاق محدود."],
      ...
      inquiry: {
        ...
        body: "شارك نوع الطلب، الوجهة، التاريخ، وعدد الأشخاص إن وجد. بعدها تحصل على مسار تنفيذ واضح.",
