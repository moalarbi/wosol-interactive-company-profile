...
const arabicServiceCopy = {
  ...
  "luxury-accommodation": {
    ...
    tagline: "اختيارات سكنية تتشكل حول طبيعة طلبك.",
  ...
  ar: {
    ...
    sections: {
      essence: {
        ...
        body: [
          "تعتمد منهجيتنا على التخطيط المدروس الذي يسبق الفعل.",
          "نضمن أن كل ترتيب يأتي كامتداد طبيعي لأسلوب حياتك الخاص."
        ],
        cards: [
          ["فهم السياق", "لا نبدأ بأي إجراء قبل الاستيعاب العميق لتفضيلاتك وإيقاع وقتك، ليكون كل ما نقدمه متسقاً مع تطلعاتك الشخصية."],
          ["الانتقاء الذكي", "نبتعد عن كثرة الخيارات المربكة؛ نختار لك بعناية ما يطابق معاييرك، ونستعرض جوهر الحلول الأكثر ملاءمة."],
      ...
      global: {
        ...
        body: ["بمجرد اختيار المسار المفضل، نتحمل نحن مسؤولية إدارة الأجواء والمتابعة الدقيقة.", "تكتمل ترتيباتك بأعلى معايير الإتقان السعودي، لتبقى أنت على اطلاع دائم بالنتائج دون الانشغال بإدارة التفاصيل التشغيلية بنفسك."],
      ...
      inquiry: {
        label: "تقييم خاص",
        title: "ابدأ بطلب خاص",
        body: "الخطوة الأولى نحو حياة أكثر سهولة وسكينة. شاركونا تطلعاتكم عبر تطبيق وصول كونسيرج، وسيتولى فريقنا مراجعة الطلب واقتراح المسار الذي يضمن لكم أقصى درجات الراحة الذهنية. لأن الفخامة الحقيقية هي الشعور بأن كل شيء مُدار بعناية.",
