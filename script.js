...
const arabicServiceCopy = {
  "lifestyle-concierge": {
    title: "كونسيرج نمط الحياة",
    tagline: "تفاصيلك اليومية تدار بهدوء وخصوصية.",
    description: "ندير الطلبات الشخصية والمواعيد والتجارب اليومية بطريقة تحفظ وقتك وتخفف الانشغال بالتفاصيل.",
    outcome: "وقت أكثر لك، وتفاصيل أقل عليك.",
    forWhom: ["الأفراد", "العائلات", "كثيرو السفر", "أصحاب الجداول المزدحمة"],
    whenItMatters: ["جدول يومي مزدحم", "طلبات منزلية وشخصية", "مناسبات خاصة", "مهام متكررة"],
    wosolHandles: ["استقبال الطلب", "تنسيق المواعيد", "متابعة المورّدين", "اقتراح التجارب", "التأكيد والمتابعة"],
    difference: "نتعرف على تفضيلاتك مع الوقت، فتصل الخدمة أسرع وبشرح أقل.",
    sampleRequests: ["ترتيب عشاء خاص", "تنسيق خدمة منزلية", "حجز تجربة نهاية أسبوع", "موعد تسوق خاص", "تحضير مناسبة شخصية"],
    cta: "اطلب دعم نمط الحياة",
    imageLabel: "إدارة حياة خاصة"
  },
  "travel-management": {
    title: "إدارة السفر",
    tagline: "رحلتك مرتبة من الفكرة حتى العودة.",
    description: "ننسق الرحلات والإقامة والتنقلات والتفاصيل المصاحبة حتى تكون الرحلة مريحة وواضحة من البداية.",
    outcome: "رحلة أسهل، بتفاصيل مترابطة ومتابعة مستمرة.",
    ...
    difference: "نتعامل مع الرحلة كتجربة واحدة، لا كحجوزات منفصلة.",
  ...
  "private-aviation": {
    title: "الطيران الخاص",
    tagline: "تنقل جوي خاص بدقة ومرونة.",
    description: "ننسق خيارات الطائرة والمسار والتفضيلات وخدمات ما قبل الرحلة وبعدها لتكون الرحلة أسرع وأكثر خصوصية.",
    outcome: "تنقل خاص يناسب وقتك وجدولك.",
    ...
    difference: "لا نقف عند الطائرة فقط؛ ننسق الرحلة كاملة قبل الإقلاع وبعد الوصول.",
  ...
  "luxury-accommodation": {
    title: "الإقامة الفاخرة",
    tagline: "إقامة مختارة حول راحتك وخصوصيتك.",
    description: "نرشح الفلل والشاليهات والبنتهاوس والإقامات الخاصة، مع تنسيق الخدمات اللازمة قبل الوصول وأثناء الإقامة.",
    outcome: "إقامة جاهزة تشبه أسلوب حياتك.",
    ...
    difference: "نختار الإقامة كمساحة معيشة كاملة، لا كمكان جميل فقط.",
  ...
  "yacht-charters": {
    title: "تأجير اليخوت",
    tagline: "تجربة بحرية مرتبة حسب المناسبة.",
    description: "ننسق رحلات اليخوت الخاصة، من طلعة قصيرة إلى برنامج بحري كامل، مع الاهتمام بالضيوف والضيافة والتنقلات.",
    outcome: "وقت خاص في البحر بلا انشغال بالتنظيم.",
    ...
    difference: "نصمم التجربة حول الضيوف والخصوصية ونبرة المناسبة.",
  ...
  "health-wellness-resorts": {
    title: "منتجعات الصحة والاستشفاء",
    tagline: "استجمام مختار بعناية وخصوصية.",
    description: "نرشح برامج ومنتجعات عافية تناسب احتياجك، مع تنسيق الإقامة والسفر والتفضيلات الخاصة.",
    outcome: "استراحة هادئة تعيد لك التوازن.",
    ...
    difference: "نختار ما يناسبك فعلاً، لا ما يبدو رائجاً فقط.",
  ...
  "shopping-gifting": {
    title: "التسوق والإهداء",
    tagline: "اختيارات راقية بلا بحث طويل.",
    description: "نساعد في اختيار الهدايا والقطع الخاصة والتجارب المرتبطة بالمناسبة، بما يناسب الذوق والعلاقة والسياق.",
    outcome: "هدية مناسبة، في وقتها، وبأسلوب يليق بالمناسبة.",
    ...
    difference: "نوازن بين الفخامة والمعنى، حتى تكون الهدية مناسبة للشخص لا للسعر فقط.",
  ...
  "business-travel-management": {
    title: "إدارة سفر الأعمال",
    tagline: "سفر عملي منظم حول وقتك.",
    description: "ننسق سفر التنفيذيين والفرق والوفود، من الرحلات والإقامة إلى التنقلات وجدول الاجتماعات.",
    outcome: "وصول منظم وتركيز أكبر على هدف الرحلة.",
    ...
    difference: "ننظر لسفر الأعمال كجزء من الإنتاجية، لا كمجرد انتقال.",
  ...
  "personal-assistant": {
    title: "المساعد الشخصي",
    tagline: "طلبك يتحول إلى خطوات واضحة.",
    description: "ندير الطلبات الشخصية الحساسة أو المعقدة، ونحولها إلى تنفيذ مرتب مع متابعة حتى الاكتمال.",
    outcome: "طلب مفهوم ومنفذ دون استنزاف وقتك.",
    ...
    difference: "نختصر عليك الشرح والمتابعة ونبقيك على اطلاع بما يلزم فقط.",
  ...
  "special-request": {
    title: "الطلبات الخاصة",
    tagline: "للطلبات التي لا تشبه المعتاد.",
    description: "نتعامل مع الطلبات غير التقليدية بسرية وواقعية، ونحدد أفضل طريقة ممكنة لتنفيذها.",
    outcome: "طلب صعب يتحول إلى خطة قابلة للتنفيذ.",
    ...
    difference: "نعطي الطلب غير الواضح هيكلاً واضحاً، ثم نديره خطوة بخطوة.",
  ...
  "transportation-services": {
    title: "خدمات التنقل",
    tagline: "تنقل مريح ومنظم من الباب إلى الباب.",
    description: "ننسق السيارات والسائقين والمسارات والتوقيت، سواء لرحلة يومية أو وصول ضيوف أو مناسبة خاصة.",
    outcome: "تنقل هادئ، دقيق، وموثوق.",
    ...
    difference: "ندير تجربة التنقل كاملة، لا السيارة وحدها.",
  ...
  "corporate-concierge-services": {
    ...
    tagline: "ضيافة وتنظيم يليقان باسم الشركة.",
    description: "ندعم الشركات في استقبال الضيوف وتنظيم السفر والتنقلات والضيافة والاجتماعات الخاصة.",
    outcome: "تجربة ضيافة منظمة تعكس مستوى الشركة.",
    ...
    difference: "نوفر للشركة خدمة كونسيرج جاهزة دون الحاجة إلى فريق داخلي.",
  ...
  "event-planning": {
    title: "تخطيط المناسبات",
    tagline: "مناسبة مرتبة بتفاصيل هادئة.",
    description: "ننسق المناسبات الخاصة والتنفيذية، من الفكرة والموقع إلى الضيافة وتجربة الضيوف يوم المناسبة.",
    outcome: "تستمتع بالمناسبة بينما ندير التفاصيل.",
    ...
    difference: "نربط التنظيم بذوق المضيف وخصوصية المناسبة.",
  ...
  "arts-design": {
    title: "الفنون والتصميم",
    tagline: "مساحات واختيارات تعكس الذوق الشخصي.",
    description: "ننسق الوصول إلى مصممين ومعارض خاصة واقتناء أعمال فنية، مع دعم تطوير المساحات الخاصة.",
    outcome: "مساحة أو مجموعة أكثر اتساقاً مع شخصيتك.",
    ...
    difference: "نجمع بين الذوق والوصول والتنفيذ في مسار واحد.",
  ...
  "vip-access": {
    title: "الوصول الخاص",
    tagline: "وصول مدروس عبر قنوات موثوقة.",
    description: "ننسق الوصول إلى فعاليات ومواقع وتجارب مختارة، مع مراعاة التوقيت والخصوصية وشروط الدخول.",
    outcome: "وصول هادئ ومحسوب، بلا وعود مبالغ فيها.",
    ...
    difference: "نبحث عن الوصول المناسب عبر الطريق الصحيح، لا عبر وعود سطحية.",
  ...
  "real-estate": {
    title: "العقارات",
    tagline: "وصول عقاري خاص يناسب نمط حياتك.",
    description: "ندعم البحث عن مساكن وفرص عقارية مختارة عبر شركاء موثوقين، مع ترتيب الزيارات والإقامة عند الحاجة.",
    outcome: "قرار عقاري أوضح، بخصوصية ومعلومات أفضل.",
    ...
    difference: "ننظر للعقار من زاوية الحياة اليومية والخصوصية، لا من زاوية السوق فقط.",
...
const content = {
  ...
  ar: {
    ...
    cover: {
      label: "",
      title: "خدمات كونسيرج خاصة لحياة أسهل.",
      desc: "ندير السفر، الوصول، الضيافة، المناسبات، والتفاصيل اليومية بخصوصية عالية وتنفيذ هادئ.",
      sub: "كونسيرج · سفر · وصول خاص · مناسبات · نمط حياة",
      visual: "تنسيق خاص يحفظ وقتك وخصوصيتك."
    },
    summary: "وصول كونسيرج شريكك في إدارة التفاصيل الخاصة. نرتب السفر، الضيافة، الوصول، المناسبات، والتنقلات اليومية <strong>بخصوصية وموثوقية</strong> حتى يبقى وقتك لما هو أهم.",
    sections: {
      essence: {
        num: "02",
        title: "فكرة وصول",
        label: "تفاصيل أقل عليك",
        body: [
          "وصول تخدم من يحتاج إلى ترتيب خاص وموثوق لحياته اليومية وسفره وتجارب ضيوفه.",
          "نختصر عليك البحث والمتابعة والتنسيق، ونحافظ على الخصوصية في كل خطوة."
        ],
        cards: [
          ["الوضوح", "نحول الطلب إلى خطوات عملية ومواعيد واضحة."],
          ["الوقت", "نتابع التفاصيل بدل أن تتابعها بنفسك."],
          ["الخصوصية", "نتعامل مع الطلبات بحذر واحترام للسياق الشخصي والمهني."]
        ]
      },
      principles: {
        num: "03",
        ...
        cards: [
          ["الرؤية", "أن تكون وصول مرجعاً موثوقاً لخدمات الكونسيرج الخاصة في المنطقة وخارجها."],
          ["الرسالة", "تقديم خدمات مرتبة وراقية تسهّل حياة العميل وتحفظ وقته وخصوصيته."],
          ["القيم", "الخصوصية، الذوق، الوضوح، وسرعة التنفيذ دون مبالغة أو استعراض."]
        ]
      },
      global: {
        num: "04",
        ...
        body: ["نخدمك داخل المملكة وخارجها عبر شبكة شركاء مختارة.", "سواء كان الطلب سفراً، إقامة، وصولاً خاصاً، أو مناسبة، ننسق التفاصيل بحسب الوجهة والوقت والاحتياج."],
      ...
      ecosystem: {
        ...
        body: ["نعتمد على شبكة علاقات وشركاء تساعدنا في ترتيب التجارب المناسبة، مع الحفاظ على السرية ووضوح التوقعات."],
      ...
      segments: {
        ...
        cards: [
          ["الأفراد", "ترتيب السفر، المواعيد، الطلبات الخاصة، والتجارب اليومية.", "كونسيرج نمط الحياة، المساعد الشخصي، الوصول الخاص"],
          ["الشركات والتنفيذيون", "تنسيق السفر، الضيافة، الاجتماعات، ورعاية الضيوف.", "سفر الأعمال، كونسيرج الشركات، التنقل"],
          ["العائلات", "دعم مستمر للإقامة، السفر، المناسبات، والخدمات المنزلية.", "الإقامة الفاخرة، إدارة السفر، كونسيرج نمط الحياة"],
          ["الضيوف المهمون", "استقبال وتنقل ووصول خاص بتجربة هادئة ومنظمة.", "الوصول الخاص، التنقل، تخطيط المناسبات"],
          ["الشركاء", "خدمة كونسيرج تضيف قيمة لتجربة عملائهم.", "كونسيرج الشركات، المناسبات، تأجير اليخوت"]
        ]
      },
      process: {
        num: "09",
        ...
        steps: [
          ["استقبال الطلب", "نفهم المطلوب والوقت والخصوصية المتوقعة."],
          ["تحديد الاحتياج", "نلخص الخيارات ونختار المسار الأنسب."],
          ["التنسيق", "نتواصل مع الشركاء والموردين ونرتب التفاصيل."],
          ["التنفيذ", "نتابع المواعيد والتأكيدات وأي تغييرات."],
          ["تحسين مستمر", "نتعرف على تفضيلاتك لتصبح الخدمة أسرع لاحقاً."]
        ]
      },
      standard: {
        num: "10",
        ...
        cards: [
          ...
          ["الذوق", "نختار ما يناسب السياق، لا ما يلفت الانتباه فقط."],
          ["الوضوح", "نشرح الخيارات والتوقعات دون مبالغة."],
          ["الثقة", "نعمل عبر شركاء ومسارات مناسبة."],
          ["المرونة", "نتعامل مع التغييرات بسرعة وهدوء."],
          ["المعرفة", "كل طلب يساعدنا على فهم تفضيلاتك أكثر."]
        ]
      },
      inquiry: {
        label: "التواصل والطلب الخاص",
        title: "ابدأ بطلبك الخاص.",
        body: "شاركنا ما تحتاجه: رحلة، إقامة، مناسبة، وصول خاص، أو طلب شخصي. سنراجع التفاصيل ونقترح المسار الأنسب بسرية ووضوح.",
