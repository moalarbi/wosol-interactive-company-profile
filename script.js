...
const arabicServiceCopy = {
  "lifestyle-concierge": {
    title: "كونسيرج نمط الحياة",
    tagline: "إدارة الطلبات اليومية الخاصة من جهة واحدة.",
    description: "نتولى المواعيد، الطلبات الشخصية، التجارب، والمتابعة اليومية وفق تفضيلات واضحة وخصوصية عالية.",
    outcome: "تنفيذ أسرع ومتابعة أقل من طرفك.",
    ...
    difference: "نحوّل الطلبات اليومية إلى مهام واضحة بمالك تنفيذ واحد.",
  ...
  "travel-management": {
    title: "إدارة السفر",
    tagline: "تخطيط وتنفيذ كامل للرحلة.",
    description: "ننسق الرحلات، الإقامة، التنقلات، الحجوزات، والتعديلات الطارئة ضمن برنامج واحد واضح.",
    ...
    difference: "نربط كل تفاصيل الرحلة في مسار واحد بدل إدارة حجوزات متفرقة.",
  ...
  "private-aviation": {
    title: "الطيران الخاص",
    tagline: "تنسيق طيران خاص بمعايير دقيقة.",
    description: "نرتب الطائرة، المسار، أوقات الإقلاع، الخدمات المرافقة، والتنقلات الأرضية قبل الرحلة وبعدها.",
    ...
    difference: "ندير تجربة الانتقال كاملة، من قرار السفر حتى الوصول النهائي.",
  ...
  "luxury-accommodation": {
    title: "الإقامة الفاخرة",
    tagline: "إقامات خاصة يتم اختيارها وتجهيزها مسبقاً.",
    description: "نرشح الفلل والشاليهات والبنتهاوس والإقامات الخاصة، وننسق الخدمات المطلوبة قبل الوصول وأثناء الإقامة.",
    ...
    difference: "نقيّم الإقامة من حيث الخصوصية والخدمة والموقع وقابلية التشغيل.",
  ...
  "yacht-charters": {
    title: "تأجير اليخوت",
    tagline: "تنسيق يخوت خاصة للرحلات والمناسبات.",
    description: "نرتب اليخت، المسار، الطاقم، الضيافة، وتنقلات الضيوف حسب مدة الرحلة وطبيعة المناسبة.",
    ...
    difference: "نضبط التجربة حسب عدد الضيوف، الخصوصية، مستوى الضيافة، والتوقيت.",
  ...
  "health-wellness-resorts": {
    title: "منتجعات الصحة والاستشفاء",
    tagline: "برامج استشفاء وعافية مختارة حسب الهدف.",
    description: "نرشح المنتجعات والبرامج المناسبة للتعافي، الراحة، أو إعادة التوازن، مع تنسيق السفر والإقامة.",
    ...
    difference: "نقارن الخيارات بناءً على الهدف، الخصوصية، جودة البرنامج، وسهولة الوصول.",
  ...
  "shopping-gifting": {
    title: "التسوق والإهداء",
    tagline: "اختيار وتنسيق للهدايا والقطع الخاصة.",
    description: "نرتب البحث، الاختيار، الشراء، التغليف، والتوصيل بما يناسب الشخص والمناسبة والميزانية.",
    ...
    difference: "نختار بناءً على السياق والعلاقة، لا على الفخامة وحدها.",
  ...
  "business-travel-management": {
    title: "إدارة سفر الأعمال",
    tagline: "إدارة سفر تنفيذي حول الوقت والالتزامات.",
    description: "ننسق سفر التنفيذيين والفرق والوفود، من الرحلات والإقامة إلى التنقلات وجدول الاجتماعات والتغييرات.",
    ...
    difference: "نربط السفر بالاجتماعات والوقت والمتابعة، لا بخط سير الرحلة فقط.",
  ...
  "personal-assistant": {
    title: "المساعد الشخصي",
    tagline: "تنفيذ شخصي للطلبات التي تحتاج متابعة دقيقة.",
    description: "ندير الطلبات الشخصية الحساسة أو المعقدة، من الفهم والتخطيط إلى التنسيق والإغلاق.",
    ...
    difference: "نستلم الطلب ونحوّله إلى خطوات تنفيذية بدل تركه مفتوحاً للمتابعة اليومية.",
  ...
  "special-request": {
    title: "الطلبات الخاصة",
    tagline: "تنسيق خاص للطلبات غير التقليدية.",
    description: "نراجع الطلب، نحدد قابليته للتنفيذ، ونقترح مساراً عملياً عبر القنوات المناسبة.",
    ...
    difference: "نتعامل مع الطلب بواقعية وسرية، مع توضيح الخيارات قبل التنفيذ.",
  ...
  "transportation-services": {
    title: "خدمات التنقل",
    tagline: "إدارة تنقلات خاصة بسائقين ومركبات مناسبة.",
    description: "ننسق السيارات، السائقين، المسارات، الجداول، وخطط الوصول للرحلات اليومية أو الضيوف أو المناسبات.",
    ...
    difference: "نرتب المركبة والسائق والمسار والتوقيت كعملية واحدة.",
  ...
  "corporate-concierge-services": {
    ...
    tagline: "دعم كونسيرج للشركات والضيوف التنفيذيين.",
    description: "ندعم الشركات في استقبال الضيوف، تنظيم السفر والتنقلات، ترتيب الضيافة، ومتابعة تفاصيل الزيارة.",
    ...
    difference: "نوفر للشركة جهة تنفيذ خارجية تحفظ مستوى الضيافة وتخفف العبء التشغيلي.",
  ...
  "event-planning": {
    title: "تخطيط المناسبات",
    tagline: "تخطيط مناسبات خاصة وتنفيذها من البداية للنهاية.",
    description: "نرتب الفكرة، الموقع، الموردين، الضيافة، حركة الضيوف، وخطة يوم المناسبة.",
    ...
    difference: "نحول المناسبة إلى خطة تنفيذ واضحة تشمل الوقت، الموردين، والضيوف.",
  ...
  "arts-design": {
    title: "الفنون والتصميم",
    tagline: "تنسيق للفن والتصميم والمقتنيات الخاصة.",
    description: "نرتب الوصول إلى مصممين، معارض، أعمال فنية، وموردين متخصصين لتطوير المساحات والمجموعات الخاصة.",
    ...
    difference: "نربط الاستشارة بالوصول للموردين والمتابعة حتى التنفيذ.",
  ...
  "vip-access": {
    title: "الوصول الخاص",
    tagline: "تنسيق وصول خاص وفق الشروط المتاحة.",
    description: "نراجع الطلب وننسق الوصول إلى فعاليات، مواقع، مطاعم، وتجارب مختارة بحسب التوقيت والتوفر والخصوصية.",
    ...
    difference: "نوضح ما يمكن ترتيبه فعلياً وننفذه عبر المسار الأنسب.",
  ...
  "real-estate": {
    title: "العقارات",
    tagline: "بحث عقاري خاص عبر شركاء موثوقين.",
    description: "ندعم البحث عن مساكن وفرص عقارية مختارة، وننسق الزيارات والتقييم الأولي والإقامة عند الحاجة.",
    ...
    difference: "نراجع العقار من زاوية الاستخدام الفعلي، الموقع، الخصوصية، والخدمة المحيطة.",
...
const content = {
  ...
  ar: {
    ...
    cover: {
      label: "",
      title: "إدارة كونسيرج خاصة للأفراد والشركات.",
      desc: "ننسق السفر، الإقامة، التنقل، الضيافة، الوصول الخاص، والمناسبات من طلب واحد إلى تنفيذ مكتمل.",
      sub: "كونسيرج خاص · سفر · ضيافة · وصول · مناسبات",
      visual: "تنسيق خاص بمعايير تنفيذ واضحة."
    },
    summary: "وصول كونسيرج جهة تنسيق خاصة للأفراد والعائلات والشركات. نتولى الطلبات التي تحتاج <strong>خصوصية، سرعة، وشركاء موثوقين</strong>، من التخطيط وحتى التأكيد النهائي.",
    sections: {
      essence: {
        num: "02",
        title: "ما تقدمه وصول",
        ...
        body: [
          "وصول تدير الطلبات الخاصة التي تتطلب وقتاً، علاقات، متابعة، وحكماً دقيقاً.",
          "نحدد المطلوب، نختار المسار الأنسب، ننسق مع الشركاء، ونتابع حتى اكتمال التنفيذ."
        ],
        cards: [
          ["التنفيذ", "نحول الطلب إلى خطة واضحة ومسؤوليات محددة."],
          ["المتابعة", "نتابع الموردين والمواعيد والتأكيدات نيابة عنك."],
          ["الخصوصية", "نتعامل مع المعلومات والحركة الشخصية بسرية كاملة."]
        ]
      },
      principles: {
        num: "03",
        ...
        cards: [
          ["الرؤية", "أن تكون وصول مرجعاً موثوقاً لخدمات الكونسيرج الخاصة في المملكة والمنطقة."],
          ["الرسالة", "تنفيذ طلبات السفر، الضيافة، الوصول، والمناسبات بمعايير عالية وخصوصية واضحة."],
          ["القيم", "الخصوصية، الدقة، وضوح التوقعات، جودة الشركاء، وسرعة المتابعة."]
        ]
      },
      global: {
        num: "04",
        ...
        body: ["نخدمك داخل المملكة وخارجها عبر شبكة شركاء مختارة.", "سواء كان الطلب سفراً، إقامة، وصولاً خاصاً، أو مناسبة، نحدد الخيارات المتاحة وننسق التنفيذ حسب الوجهة والوقت والميزانية."],
        metrics: [["16", "خدمة رئيسية"], ["05", "شرائح عملاء"], ["عالمي", "حسب الوجهة والطلب"], ["خاص", "تواصل مباشر وسري"]]
      },
      ecosystem: {
        num: "05",
        title: "شبكة الوصول",
        label: "شركاء وتجارب مختارة",
        body: ["نعمل عبر علاقات وشركاء في قطاعات الضيافة، السفر، التنقل، العقار، والمناسبات، مع وضوح في التوفر والشروط قبل التنفيذ."],
      ...
      segments: {
        ...
        cards: [
          ["الأفراد", "إدارة السفر، الطلبات الشخصية، الوصول الخاص، والتنسيق اليومي.", "كونسيرج نمط الحياة، المساعد الشخصي، الوصول الخاص"],
          ["الشركات والتنفيذيون", "تنسيق سفر الأعمال، استقبال الضيوف، الاجتماعات، والضيافة.", "سفر الأعمال، كونسيرج الشركات، التنقل"],
          ["العائلات", "تنسيق الإقامات، السفر، المناسبات، والخدمات المرتبطة بالمنزل.", "الإقامة الفاخرة، إدارة السفر، كونسيرج نمط الحياة"],
          ["الضيوف المهمون", "استقبال، تنقل، إقامة، ووصول خاص بمعايير واضحة.", "الوصول الخاص، التنقل، تخطيط المناسبات"],
          ["الشركاء", "خدمة كونسيرج داعمة تضيف قيمة لتجربة عملائهم.", "كونسيرج الشركات، المناسبات، تأجير اليخوت"]
        ]
      },
      process: {
        num: "09",
        ...
        steps: [
          ["استقبال الطلب", "نحدد المطلوب، الوقت، الميزانية، ومستوى الخصوصية."],
          ["تقييم الخيارات", "نراجع المسارات المتاحة ونوضح ما يمكن تنفيذه."],
          ["التنسيق", "نتواصل مع الشركاء والموردين ونثبت التفاصيل."],
          ["التنفيذ", "نتابع المواعيد والتأكيدات والتغييرات حتى الإغلاق."],
          ["تراكم المعرفة", "نحفظ التفضيلات المهمة لتسريع الطلبات القادمة."]
        ]
      },
      standard: {
        num: "10",
        ...
        label: "مبادئ الخدمة",
        cards: [
          ["الخصوصية", "نحافظ على معلومات العميل وحركته وتفاصيل طلبه."],
          ["الدقة", "نثبت المواعيد، الموردين، والمتطلبات قبل التنفيذ."],
          ["الوضوح", "نشرح الخيارات والتوقعات دون مبالغة."],
          ["الشركاء", "نعمل عبر جهات مناسبة حسب نوع الطلب."],
          ["المرونة", "نتعامل مع التغييرات بخطة بديلة كلما أمكن."],
          ["المعرفة", "نوثق التفضيلات المهمة لتقليل الشرح في الطلبات القادمة."]
        ]
      },
      inquiry: {
        label: "التواصل والطلب الخاص",
        title: "ابدأ بطلبك الخاص.",
        body: "شاركنا نوع الطلب، المدينة أو الوجهة، التاريخ، وعدد الأشخاص إن وجد. سنراجع التفاصيل ونحدد المسار الأنسب للتنفيذ بسرية ووضوح.",
