...
const arabicServiceCopy = {
  "lifestyle-concierge": {
    title: "كونسيرج نمط الحياة",
    tagline: "تفاصيلك اليومية تُدار بهدوء، ووقتك يبقى لك.",
    description: "تنسيق شخصي للمواعيد، الطلبات اليومية، التجارب، والخدمات المنزلية وفق تفضيلاتك ودرجة الخصوصية التي تناسبك.",
    outcome: "تقل المتابعة من طرفك، وتصل التفاصيل إلى نتيجة واضحة.",
    ...
    wosolHandles: ["استقبال الطلب", "تحديد الأولوية", "تنسيق الموردين", "ترتيب التجربة", "المتابعة حتى التأكيد"],
    difference: "تتعامل وصول مع تفاصيلك كعلاقة مستمرة، لا كطلب منفصل في كل مرة.",
    sampleRequests: ["عشاء خاص", "خدمة منزلية", "برنامج نهاية أسبوع", "موعد تسوق خاص", "تجهيز مناسبة شخصية"],
    cta: "اطلب كونسيرج نمط الحياة",
    imageLabel: "إدارة يومية خاصة"
  },
  "travel-management": {
    title: "إدارة السفر",
    tagline: "رحلة واحدة، تفاصيل كثيرة، ومسار واضح.",
    description: "تنسيق الرحلات، الإقامة، التنقلات، المطاعم، والخدمات المرافقة ضمن خطة واحدة قابلة للتعديل.",
    outcome: "رحلتك تتحرك بتأكيدات واضحة ومتابعة تقلل المفاجآت.",
    ...
    difference: "بدل ملاحقة حجوزات متفرقة، تحصل على جهة واحدة تربط الرحلة كاملة.",
    sampleRequests: ["برنامج سفر كامل", "استقبال من المطار", "تنسيق الفندق والمطاعم", "خطة سفر عائلية", "تعديل المسار أثناء الرحلة"],
    cta: "خطط رحلة خاصة",
    imageLabel: "سفر فاخر وسلس"
  },
  "private-aviation": {
    title: "الطيران الخاص",
    tagline: "طيران خاص يناسب وقتك وطبيعة رحلتك.",
    description: "تنسيق خيارات الطائرات، المسارات، أوقات الإقلاع، النقل الأرضي، والخدمات المرافقة قبل الرحلة وبعدها.",
    outcome: "حركة جوية خاصة أكثر مرونة، مع تفاصيل واضحة حول الجدول والمتطلبات.",
    ...
    difference: "الطائرة جزء من الرحلة، ووصول تنسق ما قبلها وما بعدها.",
    sampleRequests: ["تنسيق طائرة خاصة", "رحلة تنفيذية متعددة المدن", "نقل من المطار إلى السكن", "ترتيبات داخل الطائرة", "استقبال خاص عند الوصول"],
  ...
  "luxury-accommodation": {
    ...
    description: "ترشيح فلل، شاليهات، بنتهاوس، وإقامات خاصة مع الخدمات التي تحتاجها قبل الوصول وأثناء الإقامة.",
    outcome: "إقامة تناسب استخدامك الفعلي، لا مجرد عنوان جميل.",
    ...
    difference: "تُراجع الإقامة من حيث الخصوصية، الخدمة، الموقع، وسهولة الحركة.",
  ...
  "yacht-charters": {
    title: "تأجير اليخوت",
    tagline: "تجربة بحرية خاصة، مصممة حول ضيوفك ومناسبتك.",
    description: "اختيار اليخت، المسار، الطاقم، الضيافة، وتنقلات الضيوف حسب مدة الرحلة وطبيعتها.",
    outcome: "تجربة بحرية منظمة بتفاصيل واضحة قبل الانطلاق.",
    ...
    difference: "كل تفصيلة تُضبط حسب عدد الضيوف، مستوى الخصوصية، الضيافة، والتوقيت.",
  ...
  "health-wellness-resorts": {
    title: "منتجعات الصحة والاستشفاء",
    tagline: "استشفاء وراحة ضمن برنامج يناسب هدفك ووقتك.",
    description: "ترشيح منتجعات وبرامج عافية مناسبة للتعافي، الراحة، أو إعادة التوازن، مع تنسيق السفر والإقامة.",
    outcome: "برنامج عافية واضح، بعيد عن الخيارات العامة.",
    ...
    difference: "تُقارن الخيارات بناءً على هدفك، خصوصيتك، جودة البرنامج، وسهولة الوصول.",
  ...
  "shopping-gifting": {
    title: "التسوق والإهداء",
    tagline: "هدية أو قطعة مختارة تصل بالطريقة المناسبة.",
    description: "دعم في البحث، الاختيار، الشراء، التغليف، والتوصيل حسب الشخص والمناسبة والميزانية.",
  ...
  "business-travel-management": {
    title: "إدارة سفر الأعمال",
    tagline: "سفر أعمال يخدم جدولك، لا يربكه.",
    description: "تنسيق الرحلات، الإقامة، التنقلات، وجدول الاجتماعات ضمن خطة واحدة مرنة.",
    outcome: "رحلة عمل أكثر انضباطاً، ووقت أقل في متابعة التفاصيل.",
    ...
    difference: "لا تحصل على خط سير فقط؛ تحصل على سفر مرتبط باجتماعاتك وأولوياتك.",
    sampleRequests: ["أسبوع سفر تنفيذي", "خطة وصول وفد", "تنقل بين المطار والاجتماعات", "فندق قريب من موقع العمل", "تعديل جدول مفاجئ"],
    cta: "نسق سفر الأعمال",
    imageLabel: "سفر أعمال"
  },
  "personal-assistant": {
    title: "المساعد الشخصي",
    tagline: "للطلبات التي تحتاج متابعة شخصية موثوقة.",
    description: "إدارة الطلبات الحساسة أو المعقدة من الفهم الأولي حتى التنفيذ، مع تحديثات مختصرة عند الحاجة.",
    outcome: "طلبك يصبح واضحاً، بمسؤولية محددة ومتابعة حتى الاكتمال.",
    ...
    difference: "بدل شرح الطلب أكثر من مرة، تحصل على جهة تفهمه وتتابعه.",
    sampleRequests: ["تذاكر صعبة", "تنسيق احتفال", "استقبال ضيوف", "البحث عن قطعة محددة", "مهمة خاصة"],
    cta: "اطلب مساعدة شخصية",
    imageLabel: "مساعدة شخصية"
  },
  "special-request": {
    title: "الطلبات الخاصة",
    tagline: "للطلبات التي لا تناسبها قائمة خدمات جاهزة.",
    description: "مراجعة الطلب بواقعية، تحديد ما يمكن تنفيذه، ثم ترتيب المسار الأنسب بسرية ووضوح.",
    outcome: "طلب معقد يتحول إلى خطوات عملية يمكن متابعتها.",
  ...
  "transportation-services": {
    title: "خدمات التنقل",
    tagline: "تنقل خاص بمركبات وسائقين مناسبين لجدولك.",
    description: "تنسيق السيارات، السائقين، المسارات، وجداول الوصول للرحلات اليومية، الضيوف، أو المناسبات.",
    outcome: "تنقل منضبط بمواعيد واضحة ومتابعة عند الحاجة.",
    ...
    difference: "التنقل يُدار كعملية واحدة: مركبة مناسبة، سائق، مسار، توقيت، وتأكيد.",
  ...
  "corporate-concierge-services": {
    ...
    tagline: "ضيوفك المهمون يظهرون أمامك بتجربة منظمة.",
    description: "تنسيق استقبال الضيوف، السفر، التنقلات، الضيافة، وتفاصيل الزيارة بما يناسب مستوى شركتك.",
    outcome: "ضيافة مؤسسية مرتبة، تقلل العبء على فريقك وتحفظ صورة الشركة.",
    ...
    difference: "تحصل شركتك على ذراع تنفيذ خارجي يحفظ مستوى الضيافة ويخفف الضغط التشغيلي.",
  ...
  "event-planning": {
    title: "تخطيط المناسبات",
    tagline: "مناسبة مرتبة من الفكرة حتى آخر تفصيلة.",
    description: "تنسيق الفكرة، الموقع، الموردين، الضيافة، وحركة الضيوف ضمن خطة تنفيذ واحدة.",
    outcome: "مناسبة أكثر هدوءاً في التنفيذ، ومسؤوليات واضحة قبل يومها.",
    ...
    difference: "تعرف مسبقاً من المسؤول عن كل تفصيلة، ومتى يجب أن تكتمل.",
  ...
  "arts-design": {
    title: "الفنون والتصميم",
    tagline: "اختيارات فنية وتصميمية أوضح لمساحتك الخاصة.",
    description: "ربطك بمصممين، معارض، أعمال فنية، وموردين مناسبين لتطوير منزلك، مكتبك، أو مجموعتك الخاصة.",
    outcome: "اختيارات مدروسة وتنفيذ منظم للمساحات والمقتنيات.",
    ...
    difference: "تحصل على مسار يربط الاختيار بالموردين والمتابعة، لا توصية منفصلة فقط.",
  ...
  "vip-access": {
    title: "الوصول الخاص",
    tagline: "وصول خاص للأماكن والتجارب التي تحتاج تنسيقاً مناسباً.",
    description: "مراجعة طلب الوصول إلى فعالية، موقع، مطعم، أو تجربة خاصة حسب التوقيت، التوفر، والخصوصية.",
    outcome: "تعرف ما يمكن ترتيبه، وما يحتاج وقتاً أو شروطاً خاصة.",
    ...
    sampleRequests: ["عشاء خاص", "حضور فعالية", "موقع خاص", "تجربة ثقافية", "استقبال ضيوف"],
    cta: "استكشف الوصول الخاص",
    imageLabel: "وصول خاص"
  },
  "real-estate": {
    title: "العقارات",
    tagline: "بحث عقاري أكثر خصوصية، وخيارات أقرب لاحتياجك.",
    description: "دعم في البحث عن مساكن أو فرص عقارية مختارة، مع ترتيب الزيارات ومراجعة الملاءمة الأولية.",
    outcome: "خيارات عقارية أوضح، وزيارات مرتبة بعيداً عن الفوضى.",
    ...
    difference: "يُراجع العقار من زاوية استخدامك الفعلي: الموقع، الخصوصية، الحركة، والخدمات المحيطة.",
...
const content = {
  ...
  ar: {
    ...
    cover: {
      label: "",
      title: "خدمات كونسيرج خاصة مصممة حولك.",
    ...
    serviceLabels: {
      ...
      when: "متى تحتاجها",
      handles: "ما نرتبه لك",
      standard: "معيار الخدمة",
      difference: "ما المختلف",
      wosolDifference: "ما تضيفه وصول",
      samples: "أمثلة على الطلبات",
