const categories = {
  lifestyle: { en: "Lifestyle Management", ar: "نمط الحياة" },
  ...
  assets: { en: "Assets, Spaces & Culture", ar: "المساحات والمقتنيات" }
};
...
const arabicServiceCopy = {
  "lifestyle-concierge": {
    title: "كونسيرج نمط الحياة",
    tagline: "جهة واحدة لطلباتك اليومية الخاصة.",
    description: "مواعيدك، طلباتك الشخصية، وتجاربك اليومية تُدار وفق تفضيلاتك وبخصوصية عالية.",
    outcome: "تحصل على تنفيذ أسرع ومتابعة أقل من طرفك.",
    forWhom: ["الأفراد", "العائلات", "كثيرو السفر", "أصحاب الجداول المكثفة"],
    whenItMatters: ["جدول مزدحم", "طلبات منزلية وشخصية", "مناسبة خاصة", "مهام متكررة"],
    wosolHandles: ["استقبال الطلب", "تنسيق المواعيد", "متابعة الموردين", "ترتيب التجارب", "التأكيد والإغلاق"],
    difference: "طلبك اليومي يتحول إلى مهمة واضحة لها مسؤول متابعة واحد.",
    sampleRequests: ["ترتيب عشاء خاص", "تنسيق خدمة منزلية", "حجز تجربة نهاية أسبوع", "موعد تسوق خاص", "تحضير مناسبة شخصية"],
    cta: "اطلب كونسيرج نمط الحياة",
    imageLabel: "إدارة يومية خاصة"
  },
  "travel-management": {
    title: "إدارة السفر",
    tagline: "رحلتك مخططة ومتابعة من البداية للنهاية.",
    description: "تحصل على برنامج واحد يجمع الرحلات، الإقامة، التنقلات، الحجوزات، وأي تعديلات طارئة.",
    outcome: "رحلة منظمة بتأكيدات واضحة ومتابعة مستمرة.",
    forWhom: ["المسافرون الخاصون", "العائلات", "الأزواج", "الضيوف"],
    whenItMatters: ["رحلات متعددة المدن", "عطلات عائلية", "سفر فاخر", "تغيير مفاجئ في الخطة"],
    wosolHandles: ["تنسيق الرحلات", "اختيار الإقامة", "ترتيب التنقلات", "خدمة الوصول", "متابعة البرنامج"],
    difference: "بدل متابعة حجوزات متفرقة، تحصل على مسار سفر واحد وواضح.",
    sampleRequests: ["برنامج سفر كامل", "نقل من المطار إلى الفيلا", "تنسيق الفندق والمطاعم", "خطة سفر عائلية", "تعديل مسار أثناء السفر"],
    cta: "خطط رحلة خاصة",
    imageLabel: "سفر فاخر وسلس"
  },
  "private-aviation": {
    title: "الطيران الخاص",
    tagline: "طيران خاص مضبوط حول جدولك.",
    description: "تصل إلى خيارات الطائرة والمسار وأوقات الإقلاع والخدمات المرافقة ضمن تنسيق واحد.",
    outcome: "رحلة خاصة منضبطة حول جدولك.",
    forWhom: ["قادة الأعمال", "العائلات", "التنفيذيون", "الضيوف المهمون"],
    whenItMatters: ["اجتماع عاجل", "رحلة متعددة المدن", "تنقل خاص", "وصول VIP", "سفر عائلي بخصوصية"],
    wosolHandles: ["تنسيق الطائرة", "اختيار المسار", "النقل الأرضي", "تفضيلات الرحلة", "خدمة الوصول"],
    difference: "لا ينتهي الطلب عند حجز الطائرة؛ يتم ربط الرحلة بما قبلها وبعدها.",
    sampleRequests: ["تنسيق طائرة خاصة", "برنامج تنقل تنفيذي", "نقل من المطار إلى السكن", "ترتيبات داخل الطائرة", "استقبال خاص عند الوصول"],
    cta: "نسق الطيران الخاص",
    imageLabel: "طيران خاص"
  },
  "luxury-accommodation": {
    title: "الإقامة الفاخرة",
    tagline: "إقامة مختارة ومجهزة قبل وصولك.",
    description: "تحصل على خيارات فلل وشاليهات وبنتهاوس وإقامات خاصة مع الخدمات المطلوبة قبل الوصول وأثناء الإقامة.",
    outcome: "إقامة جاهزة وفق احتياجك لا مجرد حجز.",
    forWhom: ["العائلات", "المسافرون لفترات طويلة", "الضيوف الخاصون", "من يبحثون عن سكن آمن"],
    whenItMatters: ["إقامة موسمية", "عطلة عائلية", "رحلة بخصوصية عالية", "احتفال", "عمل عن بعد"],
    wosolHandles: ["ترشيح العقار", "تنسيق الخدمات", "الطاهي الخاص", "الأمن والسائقون", "الدعم أثناء الإقامة"],
    difference: "يتم تقييم الإقامة من حيث الخصوصية والخدمة والموقع، لا من حيث الشكل فقط.",
    sampleRequests: ["فيلا مع طاه خاص", "شاليه عائلي", "بنتهاوس قريب من الأعمال", "سكن مع خدمة أمنية", "تجهيز المنزل قبل الوصول"],
    cta: "اطلب إقامة خاصة",
    imageLabel: "إقامة خاصة"
  },
  "yacht-charters": {
    title: "تأجير اليخوت",
    tagline: "تجربة يخت خاصة حسب ضيوفك ومناسبتك.",
    description: "يتم ترتيب اليخت، المسار، الطاقم، الضيافة، وتنقلات الضيوف حسب مدة الرحلة وطبيعتها.",
    outcome: "تجربة بحرية منظمة بتفاصيل محسومة مسبقاً.",
    forWhom: ["العائلات", "المجموعات الخاصة", "مضيفو المناسبات", "الشركات"],
    whenItMatters: ["رحلة بحرية", "مناسبة خاصة", "استضافة عملاء", "احتفال", "برنامج عدة أيام"],
    wosolHandles: ["اختيار اليخت", "تحديد المسار", "الضيافة", "تنسيق الطاقم", "تنقلات الضيوف"],
    difference: "تجربتك تضبط حسب عدد الضيوف، مستوى الخصوصية، الضيافة، والتوقيت.",
    sampleRequests: ["رحلة وقت الغروب", "رحلة عائلية", "عشاء على اليخت", "استضافة بحرية", "برنامج ساحلي"],
    cta: "رتب تجربة يخت",
    imageLabel: "تجربة يخت خاصة"
  },
  "health-wellness-resorts": {
    title: "منتجعات الصحة والاستشفاء",
    tagline: "برنامج عافية يناسب هدفك ووقتك.",
    description: "تحصل على خيارات منتجعات وبرامج مناسبة للتعافي، الراحة، أو إعادة التوازن، مع تنسيق السفر والإقامة.",
    outcome: "برنامج واضح يناسب حالتك ووقتك.",
    forWhom: ["التنفيذيون", "الأزواج", "العائلات", "من يحتاجون تعافياً أو هدوءاً"],
    whenItMatters: ["إرهاق العمل", "إعادة توازن", "بعد السفر", "عطلة صحية", "برنامج خاص"],
    wosolHandles: ["اختيار المنتجع", "تنسيق البرنامج", "الإقامة", "تفضيلات العافية", "السفر والخصوصية"],
    difference: "تُقارن الخيارات بناءً على هدفك وخصوصيتك وجودة البرنامج وسهولة الوصول.",
    sampleRequests: ["منتجع استشفاء", "نهاية أسبوع هادئة", "برنامج صحي خاص", "مدرب وطاه خاص", "عطلة عافية عائلية"],
    cta: "صمم تجربة استشفاء",
    imageLabel: "منتجع عافية خاص"
  },
  "shopping-gifting": {
    title: "التسوق والإهداء",
    tagline: "هدية أو قطعة خاصة تصل بالطريقة المناسبة.",
    description: "تحصل على دعم في البحث والاختيار والشراء والتغليف والتوصيل بما يناسب الشخص والمناسبة والميزانية.",
    outcome: "هدية مناسبة تصل في الوقت والطريقة الصحيحة.",
    forWhom: ["الأفراد", "العائلات", "التنفيذيون", "مضيفو المناسبات"],
    whenItMatters: ["هدية مهمة", "مناسبة مفاجئة", "قطعة نادرة", "تسوق خاص", "إهداء مؤسسي"],
    wosolHandles: ["فهم الذوق", "البحث والاختيار", "التغليف", "التوصيل", "اقتراحات مناسبة"],
    difference: "الاختيار يبنى على الشخص والمناسبة والعلاقة، لا على السعر أو الاسم فقط.",
    sampleRequests: ["هدية فاخرة", "قطعة نادرة", "موعد تسوق خاص", "تنسيق إهداء", "توصيل هدية"],
    cta: "اطلب تنسيق هدية",
    imageLabel: "إهداء فاخر"
  },
  "business-travel-management": {
    title: "إدارة سفر الأعمال",
    tagline: "سفر أعمال يحمي وقتك وجدولك.",
    description: "رحلاتك، إقامتك، تنقلاتك، وجدول اجتماعاتك تُدار ضمن خطة واحدة قابلة للتعديل.",
    outcome: "رحلة عمل مضبوطة تقلل التعطيل وتدعم جدولك.",
    forWhom: ["التنفيذيون", "المؤسسون", "فرق العمل", "الوفود"],
    whenItMatters: ["اجتماعات مهمة", "جولة عمل", "زيارة مستثمرين", "جدول مزدحم", "استضافة وفد"],
    wosolHandles: ["برنامج السفر", "الرحلات والفنادق", "التنقلات", "دعم الاجتماعات", "التعديلات السريعة"],
    difference: "لا تحصل على خط سير فقط؛ تحصل على سفر مرتبط باجتماعاتك والتزاماتك.",
    sampleRequests: ["أسبوع سفر تنفيذي", "خطة وصول وفد", "تنقل بين المطار والاجتماعات", "فندق قريب من الموقع", "تعديل جدول مفاجئ"],
    cta: "نسق سفر الأعمال",
    imageLabel: "سفر أعمال"
  },
  "personal-assistant": {
    title: "المساعد الشخصي",
    tagline: "طلبك الشخصي له مسار واضح حتى الإنجاز.",
    description: "الطلبات الحساسة أو المعقدة تتحول إلى خطوات مفهومة، ثم تُتابع حتى الاكتمال.",
    outcome: "طلب واضح، مسؤولية محددة، ومتابعة حتى الإنجاز.",
    forWhom: ["الأفراد", "التنفيذيون", "العائلات", "أصحاب الوقت المحدود"],
    whenItMatters: ["طلب عاجل", "تنسيق معقد", "مناسبة خاصة", "رعاية ضيوف", "مهمة حساسة"],
    wosolHandles: ["فهم الطلب", "تحديد الأولوية", "تنسيق الجهات", "التواصل بسرية", "متابعة الإنجاز"],
    difference: "بدل متابعة التفاصيل يومياً، تحصل على مسؤولية واضحة وتحديثات عند الحاجة.",
    sampleRequests: ["تذاكر صعبة", "تنسيق احتفال", "استقبال ضيوف", "البحث عن قطعة محددة", "إنجاز مهمة خاصة"],
    cta: "اطلب مساعدة شخصية",
    imageLabel: "مساعدة شخصية"
  },
  "special-request": {
    title: "الطلبات الخاصة",
    tagline: "للطلبات التي لا تدخل في قالب جاهز.",
    description: "طلبك يُراجع بواقعية، ثم تحصل على تصور واضح لما يمكن تنفيذه والمسار الأنسب.",
    outcome: "طلب غير واضح يتحول إلى خطة تنفيذ قابلة للقياس.",
    forWhom: ["الأفراد", "المكاتب العائلية", "التنفيذيون", "المضيفون"],
    whenItMatters: ["وصول نادر", "طلب حساس", "تنسيق خارج المدينة", "موعد ضاغط", "تجربة خاصة"],
    wosolHandles: ["توضيح الطلب", "بحث الخيارات", "مراجعة الخصوصية", "خطة التنفيذ", "تحديثات مختصرة"],
    difference: "تعرف الخيارات والقيود قبل التنفيذ، وتبقى تفاصيل الطلب بسرية.",
    sampleRequests: ["تجربة نادرة", "زيارة خاصة", "رعاية ضيوف بسرية", "قطعة صعبة", "برنامج مفاجئ"],
    cta: "ناقش طلباً خاصاً",
    imageLabel: "طلب خاص"
  },
  "transportation-services": {
    title: "خدمات التنقل",
    tagline: "تنقلاتك الخاصة بمركبات وسائقين مناسبين.",
    description: "تحصل على سيارات وسائقين ومسارات وجداول وصول مرتبة للرحلات اليومية أو الضيوف أو المناسبات.",
    outcome: "تنقل منضبط بمواعيد واضحة ومتابعة مباشرة.",
    forWhom: ["التنفيذيون", "العائلات", "الضيوف", "مضيفو المناسبات"],
    whenItMatters: ["نقل المطار", "سائق يومي", "وصول مناسبة", "تنسيق عدة سيارات", "تنقل بين المدن"],
    wosolHandles: ["اختيار المركبة", "تنسيق السائق", "تخطيط المسار", "قوائم الضيوف", "متابعة التوقيت"],
    difference: "التنقل يُدار كعملية واحدة: مركبة، سائق، مسار، توقيت، وتأكيد.",
    sampleRequests: ["سيارة بسائق", "مركبة عائلية", "تنقل تنفيذي", "سيارة فاخرة للقيادة", "خطة نقل ضيوف"],
    cta: "رتب التنقل",
    imageLabel: "تنقل خاص"
  },
  "corporate-concierge-services": {
    title: "كونسيرج الشركات",
    tagline: "ضيوفك التنفيذيون يحصلون على تجربة منظمة.",
    description: "يتم ترتيب استقبال الضيوف، السفر، التنقلات، الضيافة، وتفاصيل الزيارة بما يناسب مستوى شركتك.",
    outcome: "تجربة ضيافة مؤسسية واضحة ومضبوطة.",
    forWhom: ["الشركات", "الإدارات التنفيذية", "فرق الضيافة", "علاقات المستثمرين"],
    whenItMatters: ["استضافة تنفيذيين", "زيارة وفد", "اجتماع مجلس", "ترفيه عملاء", "رعاية شركاء"],
    wosolHandles: ["دعم الاجتماعات", "السفر والتنقل", "المطاعم والمواقع", "برامج الضيوف", "التنسيق الميداني"],
    difference: "تحصل شركتك على جهة تنفيذ خارجية تحفظ مستوى الضيافة وتخفف العبء التشغيلي.",
    sampleRequests: ["برنامج ضيف تنفيذي", "لوجستيات اجتماع", "عشاء مجلس", "استقبال شريك", "خدمات نمط حياة للموظفين"],
    cta: "اطلب كونسيرج الشركات",
    imageLabel: "ضيافة شركات"
  },
  "event-planning": {
    title: "تخطيط المناسبات",
    tagline: "مناسبتك لها خطة تنفيذ واضحة.",
    description: "الفكرة، الموقع، الموردون، الضيافة، حركة الضيوف، ويوم المناسبة تُرتب ضمن خطة واحدة.",
    outcome: "مناسبة منظمة بتوزيع مسؤوليات واضح.",
    forWhom: ["المضيفون", "العائلات", "الشركات", "التنفيذيون"],
    whenItMatters: ["عشاء خاص", "احتفال", "إطلاق", "استقبال تنفيذي", "مناسبة عائلية"],
    wosolHandles: ["فكرة المناسبة", "الموقع والموردون", "حركة الضيوف", "الضيافة", "إدارة اليوم"],
    difference: "تتضح لك المسؤوليات والمواعيد والموردون قبل يوم المناسبة.",
    sampleRequests: ["عشاء خاص", "احتفال مهم", "استقبال مؤسسي", "مناسبة في وجهة خارجية", "مفاجأة خاصة"],
    cta: "خطط مناسبة خاصة",
    imageLabel: "مناسبة خاصة"
  },
  "arts-design": {
    title: "الفنون والتصميم",
    tagline: "اختيارات الفن والتصميم تصبح أكثر وضوحاً.",
    description: "تصل إلى مصممين ومعارض وأعمال فنية وموردين متخصصين لتطوير مساحتك أو مجموعتك الخاصة.",
    outcome: "اختيارات أوضح وتنفيذ منظم للمساحات والمقتنيات.",
    forWhom: ["ملاك المنازل", "جامعو الأعمال", "التنفيذيون", "المكاتب العائلية"],
    whenItMatters: ["تجهيز منزل", "تحسين مكتب", "اقتناء عمل فني", "زيارة معرض", "تحديث مساحة"],
    wosolHandles: ["ترشيح مصممين", "زيارات معارض", "دعم الاقتناء", "موجز المساحة", "تنسيق الموردين"],
    difference: "تحصل على مسار يربط الاختيار بالموردين والمتابعة، لا على توصية منفصلة فقط.",
    sampleRequests: ["زيارة معرض خاص", "ترشيح مصمم", "تنسيق اقتناء عمل فني", "موجز تصميم منزل", "تجربة ثقافية"],
    cta: "نسق دعماً فنياً أو تصميمياً",
    imageLabel: "فن وتصميم"
  },
  "vip-access": {
    title: "الوصول الخاص",
    tagline: "وصول خاص بتوقعات واضحة.",
    description: "طلبك للوصول إلى فعالية أو موقع أو مطعم أو تجربة يُراجع حسب التوقيت والتوفر والخصوصية.",
    outcome: "وصول واضح التوقعات ومنسق عبر القنوات المناسبة.",
    forWhom: ["الأفراد", "التنفيذيون", "الضيوف", "مضيفو الشركات"],
    whenItMatters: ["فعالية مهمة", "موقع خاص", "مطعم مميز", "تجربة محدودة", "مناسبة ثقافية"],
    wosolHandles: ["مراجعة الطلب", "التنسيق مع الشركاء", "متطلبات الضيوف", "تخطيط الوصول", "التعامل بسرية"],
    difference: "تعرف ما يمكن ترتيبه فعلياً قبل الالتزام بأي مسار.",
    sampleRequests: ["عشاء خاص", "حضور فعالية", "استفسار عن موقع خاص", "تجربة ثقافية", "استقبال ضيوف"],
    cta: "استكشف الوصول الخاص",
    imageLabel: "وصول خاص"
  },
  "real-estate": {
    title: "العقارات",
    tagline: "بحثك العقاري يتم بخصوصية وفرز أوضح.",
    description: "تحصل على دعم في البحث عن مساكن أو فرص عقارية مختارة، مع ترتيب الزيارات والتقييم الأولي والإقامة عند الحاجة.",
    outcome: "خيارات عقارية أوضح بتنسيق أكثر خصوصية.",
    ...
    wosolHandles: ["فهم المتطلبات", "تعريف بشركاء", "زيارات خاصة", "مراجعة الملاءمة", "تنسيق الإقامة والزيارة"],
    difference: "يُراجع العقار من زاوية استخدامك الفعلي، الموقع، الخصوصية، والخدمات المحيطة.",
    sampleRequests: ["بحث عن فيلا", "زيارة شقة فاخرة", "مراجعة وجهة منزل ثان", "تعريف بفرصة", "خطة انتقال"],
    cta: "ناقش الوصول العقاري",
    imageLabel: "عقار خاص"
  }
};
...
const content = {
  ...
  ar: {
    meta: "",
    nav: { explore: "استكشف الملف", services: "الخدمات", copy: "نسخ", copied: "تم النسخ" },
    cover: {
      label: "",
      title: "كل طلب خاص لك يصبح مساراً واضحاً.",
      desc: "سواء احتجت سفراً، إقامة، تنقلاً، ضيافة، وصولاً خاصاً، أو مناسبة، تحصل على تنسيق خاص من الطلب حتى التأكيد النهائي.",
      sub: "كونسيرج خاص · سفر · ضيافة · وصول · مناسبات",
      visual: "طلبك الخاص يدار بمعايير تنفيذ واضحة."
    },
    summary: "عندما يكون طلبك خاصاً أو حساساً أو يحتاج علاقات موثوقة، تحصل على جهة واحدة تراجع الخيارات، ترتب التفاصيل، وتتابع التنفيذ <strong>بخصوصية ووضوح</strong> حتى التأكيد النهائي.",
    sections: {
      essence: {
        num: "02",
        title: "ما تحصل عليه",
        label: "إدارة خاصة للطلبات عالية الأهمية",
        body: [
          "تحصل على مسار واضح للطلبات التي تحتاج وقتاً، علاقات، متابعة، وحكماً دقيقاً.",
          "يتم تحديد المطلوب، اختيار المسار الأنسب، التنسيق مع الشركاء، ومتابعة التنفيذ حتى الاكتمال."
        ],
        cards: [
          ["التنفيذ", "طلبك يتحول إلى خطة واضحة ومسؤوليات محددة."],
          ["المتابعة", "الموردون والمواعيد والتأكيدات تُتابع نيابة عنك."],
          ["الخصوصية", "معلوماتك وحركتك الشخصية تُعامل بسرية كاملة."]
        ]
      },
      principles: {
        num: "03",
        title: "ما تعتمد عليه خدمتك",
        label: "أساس الملف التعريفي",
        cards: [
          ["الثقة", "طلبك يدار عبر جهة واضحة ومسؤولة من البداية حتى التأكيد."],
          ["الخصوصية", "تفاصيلك الشخصية، وجهتك، وضيوفك تبقى ضمن نطاق محدود."],
          ["الوضوح", "تعرف ما يمكن تنفيذه، وما يحتاج وقتاً أو شروطاً خاصة."]
        ]
      },
      global: {
        num: "04",
        title: "الوصول العالمي",
        label: "طلبك أينما كنت",
        body: ["يمكن ترتيب طلبك داخل المملكة وخارجها عبر شبكة شركاء مختارة.", "سواء كان طلبك سفراً، إقامة، وصولاً خاصاً، أو مناسبة، تحصل على خيارات واضحة حسب الوجهة والوقت والميزانية."],
        metrics: [["16", "خدمة رئيسية"], ["05", "مسارات احتياج"], ["عالمي", "حسب وجهتك وطلبك"], ["خاص", "تواصل مباشر وسري"]]
      },
      ecosystem: {
        num: "05",
        title: "شبكة الوصول",
        label: "شركاء وتجارب مختارة",
        body: ["طلبك يستفيد من علاقات وشركاء في قطاعات الضيافة، السفر، التنقل، العقار، والمناسبات، مع توضيح التوفر والشروط قبل التنفيذ."],
        items: ["فنادق فاخرة", "طيران خاص", "يخوت", "منتجعات", "مطاعم", "استشفاء", "عقارات", "أزياء", "فن وتصميم", "مناسبات"]
      },
      services: {
        num: "06",
        title: "الخدمات",
        label: "اختر الخدمة المناسبة",
      ...
      segments: {
        num: "08",
        title: "ما يناسبك",
        label: "احتياجات مختلفة، تنسيق واحد",
        cards: [
          ["إذا كنت فرداً", "تحصل على دعم في السفر، الطلبات الشخصية، الوصول الخاص، والتنسيق اليومي.", "كونسيرج نمط الحياة، المساعد الشخصي، الوصول الخاص"],
          ["إذا كنت تنفيذياً أو شركة", "تحصل على تنسيق لسفر الأعمال، استقبال الضيوف، الاجتماعات، والضيافة.", "سفر الأعمال، كونسيرج الشركات، التنقل"],
          ["إذا كان الطلب عائلياً", "تحصل على تنسيق للإقامات، السفر، المناسبات، والخدمات المرتبطة بالمنزل.", "الإقامة الفاخرة، إدارة السفر، كونسيرج نمط الحياة"],
          ["إذا كان لديك ضيوف مهمون", "تحصل على استقبال وتنقل وإقامة ووصول خاص بمعايير واضحة.", "الوصول الخاص، التنقل، تخطيط المناسبات"],
          ["إذا كنت شريكاً", "تحصل على خدمة كونسيرج داعمة تضيف قيمة لتجربة عملائك.", "كونسيرج الشركات، المناسبات، تأجير اليخوت"]
        ]
      },
      process: {
        num: "09",
        title: "طريقة العمل",
        label: "من الطلب إلى التنفيذ",
        steps: [
          ["طلبك", "تشارك المطلوب، الوقت، الميزانية، ومستوى الخصوصية."],
          ["خياراتك", "تحصل على مسارات متاحة وما يمكن تنفيذه بوضوح."],
          ["التنسيق", "تُثبت التفاصيل مع الشركاء والموردين المناسبين."],
          ["التنفيذ", "تُتابع المواعيد والتأكيدات والتغييرات حتى الإغلاق."],
          ["طلباتك القادمة", "تُحفظ التفضيلات المهمة لتقليل الشرح لاحقاً."]
        ]
      },
      standard: {
        num: "10",
        ...
        label: "مبادئ الخدمة",
        cards: [
          ["خصوصيتك", "معلوماتك وحركتك وتفاصيل طلبك تبقى ضمن نطاق محدود."],
          ["الدقة", "المواعيد والموردون والمتطلبات تُثبت قبل التنفيذ."],
          ["الوضوح", "تعرف الخيارات والتوقعات دون وعود مبالغ فيها."],
          ["الشركاء", "طلبك يمر عبر جهات مناسبة حسب نوعه."],
          ["المرونة", "عند التغيير، تحصل على بدائل كلما أمكن."],
          ["المعرفة", "تفضيلاتك المهمة تُوثق لتقليل الشرح في الطلبات القادمة."]
        ]
      },
      inquiry: {
        label: "التواصل والطلب الخاص",
        title: "ابدأ بطلبك الخاص.",
        body: "شارك نوع الطلب، المدينة أو الوجهة، التاريخ، وعدد الأشخاص إن وجد. بعدها تحصل على مراجعة واضحة للمسار الأنسب للتنفيذ بسرية ووضوح.",
    ...
    <div class="hero-layout">
      ...
      <div class="visual-frame cover-card" role="img" aria-label="${escapeHtml(c.visual)}">
        <div class="visual-caption">
          <span class="${textDirClass()}">${state.lang === "ar" ? "طلبك الخاص" : "Private Operating Layer"}</span>
...
function renderSummary() {
  document.getElementById("executiveSummary").innerHTML = `
    <span class="exec-label ${textDirClass()}">${state.lang === "ar" ? "لماذا يهمك" : "Executive Summary"}</span>
