...
const arabicServiceCopy = {
  "lifestyle-concierge": {
    ...
    description: "يتولى فريق وصول إدارة تفاصيل حياتكم اليومية وفق تطلعاتكم وإيقاع وقتكم الخاص، عبر نقطة اتصال واحدة تحفظ لكم الراحة والخصوصية.",
    outcome: "اكتمال الترتيب كما ينبغي، دون عناء المتابعة أو كثرة التفاصيل.",
    ...
    difference: "لا نعتمد في وصول على القوائم الجاهزة، بل على ذكاء الانتقاء الذي يتشكل حول طبيعة كل طلب.",
  ...
  "travel-management": {
    title: "إدارة السفر",
    tagline: "ذكاء الوصول والتحكم في تفاصيل السفر عبر نقطة اتصال واحدة.",
    description: "من خلال وصول، يشارك العضو تطلعاته ليتولى فريقنا خلف الكواليس تحليل الاحتياج وتنسيق الخيارات الموثوقة وضمان التنفيذ السلس.",
    outcome: "سكينة مُدارة في كل مرحلة من الرحلة، من التخطيط حتى العودة.",
    ...
    difference: "كل ترتيب يأتي كامتداد طبيعي لأسلوب حياة العضو، قبل المضي في أي إجراء.",
  ...
  "private-aviation": {
    title: "الطيران الخاص",
    tagline: "تنقل جوي خاص يتوافق مع معاييركم وإيقاع وقتكم.",
    description: "نختار بعناية ما يتوافق مع معاييركم، ونستعرض جوهر الخيارات الأكثر ملاءمة لتستمتعوا بقرار واثق دون عناء البحث أو كثرة الخيارات.",
    outcome: "وصول أكثر سلاسة ووقت محفوظ بترتيبات دقيقة قبل الرحلة وبعدها.",
    ...
    difference: "التنسيق لا يقف عند الطائرة، بل يمتد إلى كامل تجربة الحركة والوصول.",
  ...
  "luxury-accommodation": {
    ...
    tagline: "اختيارات إقامة مدروسة تتشكل حول طبيعة كل طلب.",
    description: "نختار بعناية ما يتوافق مع معاييركم، وننسق تفاصيل الإقامة والخدمات المصاحبة بما يمنحكم السهولة والخصوصية منذ لحظة الوصول.",
    outcome: "إقامة مهيأة حول راحتكم، لا مجرد عنوان جميل.",
    ...
    difference: "لا نعتمد على قوائم جاهزة، بل على ذكاء الانتقاء وملاءمة المكان لإيقاع حياتكم.",
  ...
  "yacht-charters": {
    title: "تأجير اليخوت",
    tagline: "تجربة بحرية خاصة تُصمم حول الضيوف والمناسبة.",
    description: "يتولى فريقنا خلف الكواليس إدارة الأجواء وتنسيق اليخت والمسار والضيافة وحركة الضيوف، حتى تكتمل الترتيبات بأعلى معايير الإتقان.",
    outcome: "وقت بحري خاص، وسهولة كاملة دون انشغال بتفاصيل التشغيل.",
    ...
    difference: "كل تفصيلة تُدار وفق طبيعة الضيوف، مستوى الخصوصية، وإيقاع المناسبة.",
  ...
  "health-wellness-resorts": {
    ...
    tagline: "راحة ذهنية وبرامج مختارة بعيداً عن الخيارات العامة.",
    description: "نختار بعناية ما يتوافق مع معاييركم وهدفكم من الراحة، ثم ننسق البرنامج والإقامة والخدمات المصاحبة بخصوصية تامة.",
    outcome: "توازن أكثر هدوءاً، وراحة مُدارة وفق احتياجكم لا وفق شهرة المكان.",
    ...
    difference: "التخصيص يبدأ من فهم السياق وإيقاع الوقت الخاص، قبل اختيار أي وجهة.",
  ...
  "shopping-gifting": {
    title: "التسوق والإهداء",
    tagline: "انتقاء مدروس يعكس الذوق والعلاقة والمناسبة.",
    description: "نختار بعناية ما يتوافق مع معاييركم، وننسق الهدية أو القطعة وفق الشخص والمناسبة وطبيعة العلاقة.",
    outcome: "اختيار مناسب يصل في الوقت وبالطريقة الصحيحة.",
    ...
    difference: "الاختيار لا يُبنى على الاسم فقط، بل على معنى الهدية وسياقها.",
  ...
  "business-travel-management": {
    ...
    tagline: "إدارة رحلات الأعمال بدقة تنفيذية تدعم أولويات جدولكم المزدحم.",
    description: "نُحيد الاحتكاك اللوجستي عبر تنسيق السفر والإقامة والتنقل وجدول الاجتماعات، مع إبقاء المكتب على اطلاع دون متابعة كل تفصيل.",
    outcome: "سفر أعمال أكثر سلاسة، ووقت محفوظ لما يستحق الانتباه.",
    ...
    difference: "السفر هنا ليس خط سير فقط، بل بنية تشغيلية تدعم إيقاع العمل.",
  ...
  "special-request": {
    ...
    tagline: "تفكيك الطلبات المعقدة وغير التقليدية وتحويلها إلى خطوات واضحة.",
    description: "نبرع في تفكيك الطلبات المعقدة وغير التقليدية، وتحويلها إلى خطوات واضحة قابلة للتنفيذ ببراعة.",
  ...
  "transportation-services": {
    ...
    tagline: "تنقل منسق يتسم بالسهولة والوضوح.",
    description: "ننسق الحركة والتنقل بما يضمن لكم ولضيوفكم وصولاً خاصاً وجدولاً زمنياً واضحاً وساكناً.",
    outcome: "سهولة في الوصول، وهدوء في الحركة، ووضوح في المواعيد.",
  ...
  "corporate-concierge-services": {
    ...
    tagline: "طبقة تنسيق خاصة لدعم الضيوف والتنفيذيين والوفود.",
    description: "نتولى تنسيق السفر والاستقبال والتنقل والضيافة للجهات، بما يحفظ وقت الفريق الداخلي ويمنح الضيوف تجربة أكثر هدوءاً.",
    outcome: "ضيافة مؤسسية أكثر سلاسة، وتفاصيل تُدار دون ضجيج.",
  ...
  "event-planning": {
    title: "تخطيط المناسبات",
    tagline: "إدارة كواليس مناسباتكم الخاصة بهدوء واحترافية.",
  ...
  "arts-design": {
    title: "رعاية المقتنيات والمساحات",
    tagline: "اختيارات مدروسة وإدارة ذكية لمساحاتكم الخاصة ومقتنياتكم الثمينة.",
    description: "ننسق التعريف بالمصممين والمعارض والموردين وفق المساحة والذائقة وطريقة الاستخدام، بهدف تعزيز الراحة والاستدامة.",
    outcome: "مساحات ومقتنيات أكثر انسجاماً مع ذوقكم وإيقاع حياتكم.",
  ...
  "vip-access": {
    title: "ذكاء الوصول",
    tagline: "وضوح تام وتنسيق مسبق للوصول إلى الفرص والمساحات الحصرية.",
    description: "نراجع إمكانية الوصول وفق التوقيت والمتطلبات، وننسق المسار المناسب بما يضمن التوافر والسهولة قبل الالتزام.",
  ...
  "real-estate": {
    title: "العقارات",
    tagline: "وصول عقاري يستند إلى الخصوصية والملاءمة وذكاء الانتقاء.",
    description: "نراجع متطلبات المسكن أو الفرصة، ثم ننسق التعريفات والزيارات وفق الخصوصية والملاءمة وطبيعة الاستخدام.",
    outcome: "خيارات أكثر صلة، وزيارات تُدار بهدوء ووضوح.",
...
const content = {
  ...
  ar: {
    ...
    cover: {
      ...
      desc: "عضوية وصول هي مساحة حصرية صُممت لتمنحكم ذكاء الوصول والتحكم في تفاصيل حياتكم وسفركم، عبر واجهة رقمية تتسم بالخصوصية المطلقة والسهولة المتناهية.",
      sub: "Luxury is feeling handled",
      visual: "الفخامة أن تشعر أن كل شيء مُدار عنك."
    },
    summary: "من خلال التطبيق، يشارك العضو تطلعاته، ليتولى فريقنا خلف الكواليس مهمة <strong>الأوركسترا التشغيلية</strong>؛ حيث نُحلل الاحتياج، نُنسق الخيارات الموثوقة، ونضمن التنفيذ السلس من خلال نقطة اتصال واحدة تضمن لكم <strong>السكينة المُدارة</strong>.",
    sections: {
      essence: {
        num: "02",
        title: "منهجية العمل",
        label: "الإيقاع والذكاء",
        body: [
          "كل طلب يبدأ باستيعاب عميق لتفضيلات العضو وإيقاع وقته الخاص.",
          "نضمن أن كل ترتيب يأتي كامتداد طبيعي لأسلوب حياته، قبل المضي في أي إجراء."
        ],
        cards: [
          ["فهم السياق", "كل طلب يبدأ باستيعاب عميق لتفضيلات العضو وإيقاع وقته الخاص."],
          ["الانتقاء المدروس", "نختار بعناية ما يتوافق مع معاييركم، ونستعرض جوهر الخيارات الأكثر ملاءمة."],
          ["الخصوصية والسرية", "تُدار تفاصيلكم وتطلعاتكم بسرية تامة وحماية فائقة، ضمن نطاق محدود جداً."]
        ]
      },
      principles: {
        num: "03",
        title: "ما تحفظه وصول",
        label: "الراحة، الوقت، الخصوصية",
        cards: [
          ["الراحة", "تستمتعون بقرار واثق دون عناء البحث أو كثرة الخيارات."],
          ["الوقت", "نُحيد الاحتكاك اللوجستي ونحفظ وقتكم لما يستحق الانتباه."],
          ["الخصوصية", "احترام كامل لمساحتكم الشخصية وسرية تامة في إدارة التفاصيل."]
        ]
      },
      global: {
        num: "04",
        ...
        body: ["بمجرد اختيار المسار المفضل، يتولى فريقنا مسؤولية إدارة الأجواء والمتابعة الدقيقة.", "تكتمل الترتيبات بأعلى معايير الإتقان، مع بقاء العضو على اطلاع دون إدارة التفاصيل بنفسه."],
        metrics: [["سياق", "يُفهم بعمق"], ["انتقاء", "يُدار بعناية"], ["تنسيق", "عبر نقطة واحدة"], ["سكينة", "مُدارة بالكامل"]]
      },
      ecosystem: {
        num: "05",
        title: "شبكة الشراكات",
        label: "التخصيص الفائق",
        body: ["لا نعتمد في وصول على القوائم الجاهزة، بل على ذكاء الانتقاء الذي يتشكل حول طبيعة كل طلب.", "يتم اختيار الشريك وفق متطلبات الطلب، ومعايير العضو، والتوقيت، ومستوى الخصوصية المطلوب."],
        items: ["فنادق مختارة", "طيران خاص", "يخوت", "منتجعات خاصة", "مطاعم وتجارب", "عافية واستشفاء", "عقارات مختارة", "أزياء خاصة", "فن وتصميم", "استضافة خاصة"]
      },
      services: {
        num: "06",
        title: "ما يمكن تنسيقه عبر عضويتك",
        label: "حلول لبنية تحتية أرقى للحياة",
        all: "كل المسارات",
      ...
      segments: {
        ...
        label: "احتياجات مختلفة ونقطة اتصال واحدة",
        cards: [
          ["الأفراد", "لمن يفضل جهة موثوقة تدير التفاصيل نيابة عنه.", "طلبات شخصية، سفر، متابعة"],
          ["التنفيذيون والمكاتب", "لدعم الجداول المزدحمة والطلبات متعددة الأطراف.", "جداول، ضيوف، تنقل"],
          ["العائلات", "لتنسيق السفر والمناسبات والاحتياجات المختلفة.", "سفر، إقامة، مناسبات"],
          ["الشركات", "لدعم الضيوف والتنفيذيين والوفود الخاصة.", "ضيافة، وفود، اجتماعات"],
          ["الضيوف الدوليون", "لترتيب الاحتياجات داخل المملكة وخارجها.", "وصول، تنقل، إقامة"]
        ]
      },
      process: {
        num: "09",
        ...
        steps: [
          ["فهم السياق", "كل طلب يبدأ باستيعاب عميق لتفضيلات العضو وإيقاع وقته الخاص."],
          ["الانتقاء المدروس", "نختار بعناية ما يتوافق مع معاييركم، ونستعرض جوهر الخيارات الأكثر ملاءمة."],
          ["الخصوصية والسرية", "تُدار تفاصيلكم وتطلعاتكم بسرية تامة وحماية فائقة."],
          ["التنسيق الموثوق", "يتولى فريقنا مسؤولية إدارة الأجواء والمتابعة الدقيقة حتى تكتمل الترتيبات."],
          ["التخصيص الفائق", "لا نعتمد على القوائم الجاهزة، بل على ذكاء الانتقاء حول طبيعة كل طلب."]
        ]
      },
      standard: {
        num: "10",
        title: "الحدود والمعايير",
        label: "وضوح يحفظ العلاقة",
        cards: [
          ["لا يوجد وعود", "نراجع كل طلب قبل تأكيد إمكانية تنفيذه."],
          ["شفافية", "وضوح التكاليف والمتطلبات قبل البدء بالتنفيذ."],
          ["مراجعة الطلب", "تقييم الطلب وتحديد آلية التعامل المناسبة."],
          ["تحفظ", "التعامل مع المعلومات بعناية واحترام للخصوصية."],
          ["استمرارية", "الحفاظ على معرفة متراكمة بالتفضيلات والاحتياجات."],
          ["ملاءمة", "اختيار الترتيب المناسب وفق سياق الطلب."]
        ]
      },
      inquiry: {
        label: "تقييم خاص",
        title: "ابدأ بطلب خاص",
        body: "ابدأوا رحلة السهولة بطلب خاص؛ شاركونا ما تحتاجونه عبر تطبيق وصول كونسيرج، وسيقوم فريقنا بمراجعة الطلب واقتراح المسار الذي يضمن لكم أقصى درجات الراحة الذهنية.",
